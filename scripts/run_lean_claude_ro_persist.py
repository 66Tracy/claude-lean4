...
from common import docker, ensure_elan_cache, ensure_dir, repo_root


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run Lean in Claude image (read-only workspace, persistent scratch)."
    )
    ...
    parser.add_argument(
        ...
        "--scratch-dir",
        default=".scratch",
        help="Scratch directory (relative to repo root or absolute).",
    )
